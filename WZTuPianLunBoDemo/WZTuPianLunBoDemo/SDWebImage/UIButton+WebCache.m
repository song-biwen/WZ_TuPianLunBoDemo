...
- (void)setAutoBtImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder completed:(SDWebImageCompletedBlock)completedBlock
{
                                                 ...
                                                 dispatch_main_sync_safe(^
                                                                         {
                                                                             ...
                                                                             if (image)
                                                                             {
                                                                                 if(image.size.width/image.size.height>sself.frame.size.width/sself.frame.size.height)
                                                                                 {
                                                                                     ...
                                                                                     CGImageRef image1 = CGImageCreateWithImageInRect(imageRef,CGRectMake((image.size.width-image.size.height*sself.frame.size.width/sself.frame.size.height)/2, 0, image.size.height*sself.frame.size.width/sself.frame.size.height, image.size.height));
                                                                                     UIImage*newImage = [[UIImage alloc] initWithCGImage:image1];
                                                                                     [sself setImage:newImage forState:state];
                                                                                     CGImageRelease(image1);
                                                                                 }else
                                                                                 {
                                                                                     CGImageRef imageRef =image.CGImage;
                                                                                     
                                                                                     CGImageRef image1 = CGImageCreateWithImageInRect(imageRef,CGRectMake(0, (image.size.height-image.size.width*sself.frame.size.height/sself.frame.size.width)/2,image.size.width,image.size.width*sself.frame.size.height/sself.frame.size.width));
                                                                                     UIImage*newImage = [[UIImage alloc] initWithCGImage:image1];
                                                                                     [sself setImage:newImage forState:state];
                                                                                     CGImageRelease(image1);
                                                                                 }
...
- (void)setSquareImageWithURL:(NSURL *)url forState:(UIControlState)state placeholderImage:(UIImage *)placeholder completed:(SDWebImageCompletedBlock)completedBlock
{
    [self cancelCurrentImageLoad];
                                                 ...
                                                 dispatch_main_sync_safe(^
                                                                         {
                                                                             ...
                                                                             if (image)
                                                                             {
                                                                                 if(image.size.width/image.size.height>1){
                                                                                     ...
                                                                                     CGImageRef image1 = CGImageCreateWithImageInRect(imageRef,CGRectMake((image.size.width-image.size.height)/2, 0, image.size.height, image.size.height));
                                                                                     UIImage*newImage = [[UIImage alloc] initWithCGImage:image1];
                                                                                     [sself setImage:newImage forState:state];
                                                                                     CGImageRelease(image1);
                                                                                 }else{
                                                                                     ...
                                                                                     CGImageRef image1 = CGImageCreateWithImageInRect(imageRef,CGRectMake(0, (image.size.height-image.size.width)/2, image.size.width, image.size.width));
                                                                                     UIImage*newImage = [[UIImage alloc] initWithCGImage:image1];
                                                                                     [sself setImage:newImage forState:state];
                                                                                     CGImageRelease(image1);
                                                                                 }
